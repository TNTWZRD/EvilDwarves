...
<header class="clearfix main-header" role="banner" style="margin-top: -25px; margin-bottom: 5px; padding: 5px;">
<h1>
Evil Dwarves StatPage <a href="" id="ReloadStats" style="color: Blue; text-decoration: none;">Reload Stats</a>
</h1>
</header>
<div class="data">
List Of All Stats:
